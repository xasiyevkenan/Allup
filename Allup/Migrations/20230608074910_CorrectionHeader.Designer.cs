...
namespace Allup.Migrations
{
    ...
    [Migration("20230608074910_CorrectionHeader")]
    partial class CorrectionHeader
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Allup.DataAccessLayer.Entity.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Allup.DataAccessLayer.Entity.Header", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Allup.DataAccessLayer.Entity.Category", b =>
                {
                    b.HasOne("Allup.DataAccessLayer.Entity.Header", "Header")
                        .WithMany("Categories")
                        .HasForeignKey("HeaderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Allup.DataAccessLayer.Entity.Category", "ParentCategory")
                        .WithMany()
